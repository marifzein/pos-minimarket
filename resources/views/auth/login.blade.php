    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4" x-data="{ show: false }">
            ...
            <div class="relative mt-1">
                <!-- Atribut :type="show ? 'text' : 'password'" diatur oleh AlpineJS bawaan Breeze -->
                <x-text-input id="password" 
                              class="block w-full pr-10 focus:border-emerald-500 focus:ring-emerald-500 rounded-lg border-gray-300"
