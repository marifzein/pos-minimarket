...
document
.getElementById('btnTambahGrosir')
.addEventListener('click',function(){

    let html=`

    <div class="grid grid-cols-2 gap-3 mb-3 grosir-row">
        ...
        <div>
            ...
            <div class="flex gap-2">
                ...
                <button
                    type="button"
                    class="hapus bg-red-500 text-white rounded px-3"
                >
                    X
                </button>
    ...
    document
    .getElementById('grosir-container')
    .insertAdjacentHTML(
        'beforeend',
        html
    );
...
document.addEventListener('click',function(e){
    ...
    if(
        e.target.classList.contains('hapus')
    ){
